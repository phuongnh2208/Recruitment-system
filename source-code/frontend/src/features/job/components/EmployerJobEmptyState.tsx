/**
 * Empty state component for when the employer has no job postings.
 *
 * ═══════════════════════════════════════════════════════════════════
 * UI COMPONENT
 * ═══════════════════════════════════════════════════════════════════
...
export interface EmployerJobEmptyStateProps {
...
export default function EmployerJobEmptyState({
  message,
  action,
}: EmployerJobEmptyStateProps) {
  return (
    <div className="rounded-card bg-white p-8 shadow-card ring-1 ring-ink/5 text-center">
      ...
      <p className="mt-4 font-body text-base text-ink/70">
        {message ??
          "Chưa có tin tuyển dụng nào. Tạo tin đầu tiên để bắt đầu tìm kiếm ứng viên."}
      </p>
