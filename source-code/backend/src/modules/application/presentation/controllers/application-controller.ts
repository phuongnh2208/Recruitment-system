...
export class ApplicationController {
  ...
  async applyJob(req: Request, res: Response, _next: NextFunction): Promise<void> {
  ...
  async updateApplicationStatus(req: Request, res: Response, _next: NextFunction): Promise<void> {
